...
[(htmlcov/index.html)](https://github.com/lidiar8r-ops/home_oop/blob/Feature/homework-14-5/htmlcov/index.html)
...
у класса созданы: 
    ...
    - функция *add_product*, которая добавляет товар в категорию.(Args: product_data: Словарь с данными товара 
        name, price, description, quantity), таким образом, без возможности добавить вместо продукта или его наследников любой другой объект..
...
* Order(BaseCategory):
класс заказа купленного товара
``` 
    Args:
...
**Доработана функциональность сложения таким образом, чтобы можно складывать товары только из одинаковых классов продуктов.**
